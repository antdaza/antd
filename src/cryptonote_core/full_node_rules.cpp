...
bool check_full_node_portions(uint8_t hf_version, const std::vector<uint64_t>& portions)
{
...
static bool get_portions_from_percent(double cur_percent, uint64_t& portions) {
  ...
  // Fix for truncation issue when operator cut = 100 for a pool Full Node.
