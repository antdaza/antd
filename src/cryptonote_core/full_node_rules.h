...
// return: UINT64_MAX if (num_contributions > the max number of contributions), otherwise the amount in antd atomic units
...
bool check_full_node_portions(uint8_t version, const std::vector<uint64_t>& portions);
