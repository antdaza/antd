...
const hardfork_t mainnet_hard_forks[] = {
  ...
  { cryptonote::network_version_8, 50, 0, 1744824295 },
  { cryptonote::network_version_9_full_nodes, 300, 0, 1744825855 },
  { cryptonote::network_version_10_bulletproofs, 400, 0, 1744826995 },
  { cryptonote::network_version_11_infinite_staking, 450, 0, 1749055791 },
  { cryptonote::network_version_12, 460, 0, 1749055891 }
};
